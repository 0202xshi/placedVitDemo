    ...
    <main id="main">
      <div class="hero-section inner-page">
        <div class="wave">
          ...
          <svg:svg width="1920px" height="265px" viewBox="0 0 1920 265" version="1.1" >
            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  <h1 data-aos="fade-up" >MICROSOFT</h1>
                  <p class="mb-5" data-aos="fade-up">CTC - 41.5 LPA</p>  
                </div>
              </div>
            </div>
          </div>
          ...
          <c:forEach begin="0" end="20" varStatus="loop">
            <div class="col-12 col-sm-6 col-md-4 col-lg-3">
              <div class="our-team">
                ...
                <a href="advice.html" class="stretched-link"></a>
              </div>
            </div>
            </c:forEach>
            </div>
