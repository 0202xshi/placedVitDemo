            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  ...
                  <p class="mb-5" data-aos="fade-up"  data-aos-delay="100">Facing any issue? Contact us now.</p>  
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row mb-5 align-items-end">
          <div class="col-md-6" data-aos="fade-up">
            ...
            <h2>Contact Form</h2>
            <p class="mb-0">Happy to assist you anytime.</p>
          </div>
              ...
              <div class="col-md-4 ml-auto order-2"  data-aos="fade-up">
                <ul class="list-unstyled">
                  <li class="mb-3">
                    ...
                    <span>L-427 , H-549 VIT Mens Hostel</span>
                  </li>
                  <li class="mb-3">
                    <strong class="d-block mb-1">Phone</strong>
                    <span>+91 98845-23855</span><br><span>+91 83026-81811</span>
                  </li>
                  <li class="mb-3">
                    <strong class="d-block mb-1">Email</strong>
                    <span>ndiveshjain@gmail.com</span><br><span>shivamsharma@gmail.com</span>
                  </li>
                </ul>
              </div>

              <div class="col-md-6 mb-5 mb-md-0"  data-aos="fade-up">
                <form action="/submitMyForm" method="post" role="form" >
