            ...
            <div class="col-12">
              <div class="row justify-content-center">
                <div class="col-md-7 text-center hero-text">
                  <h1 data-aos="fade-up" data-aos-delay="">Full Time Placed Offers</h1>
                  <p class="mb-5" data-aos="fade-up"  data-aos-delay="100">Let the carrer BEGIN!</p>  
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-4 mr-auto">
              ...
              <p><a href="/showuserPlacementSuperDream">Check List</a></p>
            </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-4 ml-auto order-2">
              ...
              <p><a href="/showuserPlacementDream">Read More</a></p>
            </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-4 mr-auto">
              ...
              <p><a href="/showuserPlacementRegular">Read More</a></p>
            </div>
            <div class="col-md-6" data-aos="fade-left">
